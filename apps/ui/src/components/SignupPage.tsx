        ...
        <div className="glass-panel p-8 sm:p-10 rounded-2xl shadow-2xl ring-1 ring-white/10 backdrop-blur-xl">
          <div className="flex flex-col items-center gap-4 text-center mb-8">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">Enter your email below to create your account</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="grid gap-4">
              ...
              {error && (
                <motion.p
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="text-sm text-red-400 text-center bg-red-500/10 py-2 rounded-md border border-red-500/20"
                >
                  {error}
                </motion.p>
              )}
